...
void findSumMultiplesOfFive(Node* head) {
    int sum = 0;
    bool found = false;
    while (head) {
    ...
    if (found) {
        cout << "Sum of negative multiples of 5: " << sum << endl;
    }
    else {
        cout << "No negative multiples of 5 found" << endl;
    }
}
